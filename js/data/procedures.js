...
export const PROCEDURES = [
  ...
  { id: "eq-after-exit", hazard: "earthquake", phase: "after", title: "揺れが収まったら火元を確かめ逃げ道を確保する", body: "コンロやストーブの火を消し、ドアや窓を開けて避難経路を確保します。ガス臭がしたら元栓を閉め換気してください。", keywords: ["火元確認", "出口確保", "ガス"] },
  ...
  { id: "eq-recover-breaker", hazard: "earthquake", phase: "recover", title: "避難する前にブレーカーを落とし通電火災を防ぐ", body: "破損した配線や電気製品に電気が戻ると火災の原因になります。避難するときは必ずブレーカーを切ってください。", keywords: ["通電火災", "ブレーカー"] },
  ...
  // ---------- heavyRain(豪雨) ----------
  { id: "rain-prep-level", hazard: "heavyRain", phase: "prepare", title: "警戒レベル1〜5の意味を家族で理解しておく", body: "レベル3で高齢者等は避難、レベル4で全員避難が原則です。数字の意味を事前に家族で共有しておきます。", keywords: ["警戒レベル", "避難情報"] },
  ...
  { id: "fl-now-noflow", hazard: "flood", phase: "now", title: "流れのある水の中を歩かない", body: "水深がひざ下でも流れがあれば転倒し流される危険があります。長い棒で足元を確かめながら判断してください。", keywords: ["流れる水", "歩行危険"] },
  { id: "fl-now-car", hazard: "flood", phase: "now", title: "冠水した道路や地下道を車で通らない", body: "浅い水深でもエンジンが停止し、車内に閉じ込められる事故が起きています。危険を感じたら迂回してください。", keywords: ["車", "冠水路", "スタック"] },
  ...
  { id: "ls-alert-early", hazard: "landslide", phase: "alert", title: "大雨が続くときは崖や斜面から離れて早めに避難する", body: "雨がやんでいても土中の水分は増え続けています。危険を感じる前の、明るいうちの避難が安全です。", keywords: ["大雨", "早めの避難"] },
  { id: "ls-alert-shelter", hazard: "landslide", phase: "alert", title: "早めの避難先を親戚・知人宅も含め複数考えておく", body: "指定避難所以外にも、警戒区域外の親戚や知人宅など避難先の選択肢を事前に決めておくと安心です。", keywords: ["避難先", "事前準備"] },
  ...
  { id: "wt-now-toilet", hazard: "waterOutage", phase: "now", title: "簡易トイレの使い方を確認しておく", body: "便器にポリ袋をかぶせ凝固剤を使う簡易トイレを用意しておくと、断水中も衛生的に使えます。", keywords: ["簡易トイレ", "凝固剤"] },
  ...
  { id: "fire-now-extinguish", hazard: "fire", phase: "now", title: "初期消火は炎が天井に届く前までを目安にする", body: "炎が天井まで達したら消火は困難です。その前の段階なら消火器や水で消火を試み、無理なら避難を優先します。", keywords: ["初期消火", "天井", "消火器"] },
  ...
  { id: "heat-now-firstaid", hazard: "heatwave", phase: "now", title: "熱中症のサインに気づいたらすぐ体を冷やす", body: "めまいや大量の汗、頭痛は初期のサインです。涼しい場所へ移動し、首・脇・脚の付け根を冷やして水分をとります。", keywords: ["熱中症", "応急処置", "冷やす"] },
